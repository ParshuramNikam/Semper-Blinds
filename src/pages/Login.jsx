  ...
  return (
    <div className="h-screen flex">
      ...
      <div className=" flex flex-col   w-full md:w-1/2 justify-center items-center bg-gray-100 ">
        <form className="bg-gray-100 p-3">
          {" "}
          {/* rounded-xl border-2 border-green-600 */}
        ...
        {!isValidUser && showError ? (
          <div
            id="alert-2"
            className="mt-5 max-w-md flex px-5 py-3 shadow mb-4 bg-red-100 rounded-lg dark:bg-red-200"
            role="alert"
          >
            <svg
