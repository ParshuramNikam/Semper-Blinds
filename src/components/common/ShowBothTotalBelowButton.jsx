...
const ShowBothTotalBelowButton = ({total, elementNo, grandTotal, hideBottomBorder}) => {
    return (
        <div className={`grid grid-cols-2 px-2 p-1 m-1 ${!hideBottomBorder ? ' border-b-2  border-sky-900' : ''}`}>
