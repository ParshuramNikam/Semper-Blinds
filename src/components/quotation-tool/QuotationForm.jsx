...
const QuotationForm = ({ blindNumber }) => {
  ...
  const useStateReturnValueFromSessionStrorage = (valueOf) => {
    return sessionStorage.getItem(valueOf + blindNumber) ||
      sessionStorage.getItem(valueOf + blindNumber) !== null
  ...
  const [motorisationToggle, setMotorisationToggle] = useState(
    sessionStorage.getItem("motorization-toggle-" + blindNumber) ||
      sessionStorage.getItem("motorization-toggle-") !== null
      ? sessionStorage.getItem("motorization-toggle-" + blindNumber)
      : false
  );
  ...
  const [currentBlindType, setCurrentBlindType] = useState(
    useStateReturnValueFromSessionStrorage("blind-type-")
  );

  const [currentFabricType, setcurrentFabricType] = useState(
    useStateReturnValueFromSessionStrorage("fabric-type-")
  );
  ...
  const [currentBlindWidth, setcurrentBlindWidth] = useState(
    useStateReturnValueFromSessionStrorage("width-")
  ); // for selet WIDTH onchange value
  const [currentBlindDepth, setcurrentBlindDepth] = useState(
    useStateReturnValueFromSessionStrorage("depth-")
  ); // for selet DEPTH onchange value

  // usestate repeat from 2nd blind width and depth :
  const [currentBlindWidth2, setcurrentBlindWidth2] = useState(
    useStateReturnValueFromSessionStrorage("width-2-")
  ); // for selet WIDTH onchange value
  const [currentBlindDepth2, setcurrentBlindDepth2] = useState(
    useStateReturnValueFromSessionStrorage("depth-2-")
  ); // for selet DEPTH onchange value

  const [currentBlindWidth3, setcurrentBlindWidth3] = useState(
    useStateReturnValueFromSessionStrorage("width-3-")
  ); // for selet WIDTH onchange value
  const [currentBlindDepth3, setcurrentBlindDepth3] = useState(
    useStateReturnValueFromSessionStrorage("depth-3-")
  ); // for selet DEPTH onchange value

  const [currentBlindWidth4, setcurrentBlindWidth4] = useState(
    useStateReturnValueFromSessionStrorage("width-4-")
  ); // for selet WIDTH onchange value
  const [currentBlindDepth4, setcurrentBlindDepth4] = useState(
    useStateReturnValueFromSessionStrorage("depth-4-")
  ); // for selet DEPTH onchange value

  const [currentBlindWidth5, setcurrentBlindWidth5] = useState(
    useStateReturnValueFromSessionStrorage("width-5-")
  );
  const [currentBlindDepth5, setcurrentBlindDepth5] = useState(
    useStateReturnValueFromSessionStrorage("depth-5-")
  );

  const [currentBlindWidth6, setcurrentBlindWidth6] = useState(
    useStateReturnValueFromSessionStrorage("width-6-")
  );
  const [currentBlindDepth6, setcurrentBlindDepth6] = useState(
    useStateReturnValueFromSessionStrorage("depth-6-")
  );
  const [currentBlindWidth7, setcurrentBlindWidth7] = useState(
    useStateReturnValueFromSessionStrorage("width-7-")
  );
  const [currentBlindDepth7, setcurrentBlindDepth7] = useState(
    useStateReturnValueFromSessionStrorage("depth-7-")
  );
  const [currentBlindWidth8, setcurrentBlindWidth8] = useState(
    useStateReturnValueFromSessionStrorage("width-8-")
  );
  const [currentBlindDepth8, setcurrentBlindDepth8] = useState(
    useStateReturnValueFromSessionStrorage("depth-8-")
  );
  const [currentBlindWidth9, setcurrentBlindWidth9] = useState(
    useStateReturnValueFromSessionStrorage("width-9-")
  );
  const [currentBlindDepth9, setcurrentBlindDepth9] = useState(
    useStateReturnValueFromSessionStrorage("depth-9-")
  );
  const [currentBlindWidth10, setcurrentBlindWidth10] = useState(
    useStateReturnValueFromSessionStrorage("width-10-")
  );
  const [currentBlindDepth10, setcurrentBlindDepth10] = useState(
    useStateReturnValueFromSessionStrorage("depth-10-")
  );
  const [currentBlindWidth11, setcurrentBlindWidth11] = useState(
    useStateReturnValueFromSessionStrorage("width-11-")
  );
  const [currentBlindDepth11, setcurrentBlindDepth11] = useState(
    useStateReturnValueFromSessionStrorage("depth-11-")
  );
  const [currentBlindWidth12, setcurrentBlindWidth12] = useState(
    useStateReturnValueFromSessionStrorage("width-12-")
  );
  const [currentBlindDepth12, setcurrentBlindDepth12] = useState(
    useStateReturnValueFromSessionStrorage("depth-12-")
  );
  const [currentBlindWidth13, setcurrentBlindWidth13] = useState(
    useStateReturnValueFromSessionStrorage("width-13-")
  );
  const [currentBlindDepth13, setcurrentBlindDepth13] = useState(
    useStateReturnValueFromSessionStrorage("depth-13-")
  );
  const [currentBlindWidth14, setcurrentBlindWidth14] = useState(
    useStateReturnValueFromSessionStrorage("width-14-")
  );
  const [currentBlindDepth14, setcurrentBlindDepth14] = useState(
    useStateReturnValueFromSessionStrorage("depth-14-")
  );
  const [currentBlindWidth15, setcurrentBlindWidth15] = useState(
    useStateReturnValueFromSessionStrorage("width-15-")
  );
  const [currentBlindDepth15, setcurrentBlindDepth15] = useState(
    useStateReturnValueFromSessionStrorage("depth-15-")
  );
  const [currentBlindWidth16, setcurrentBlindWidth16] = useState(
    useStateReturnValueFromSessionStrorage("width-16-")
  );
  const [currentBlindDepth16, setcurrentBlindDepth16] = useState(
    useStateReturnValueFromSessionStrorage("depth-16-")
  );
  const [currentBlindWidth17, setcurrentBlindWidth17] = useState(
    useStateReturnValueFromSessionStrorage("width-17-")
  );
  const [currentBlindDepth17, setcurrentBlindDepth17] = useState(
    useStateReturnValueFromSessionStrorage("depth-17-")
  );
  const [currentBlindWidth18, setcurrentBlindWidth18] = useState(
    useStateReturnValueFromSessionStrorage("width-18-")
  );
  const [currentBlindDepth18, setcurrentBlindDepth18] = useState(
    useStateReturnValueFromSessionStrorage("depth-18-")
  );
  const [currentBlindWidth19, setcurrentBlindWidth19] = useState(
    useStateReturnValueFromSessionStrorage("width-19-")
  );
  const [currentBlindDepth19, setcurrentBlindDepth19] = useState(
    useStateReturnValueFromSessionStrorage("depth-19-")
  );
  const [currentBlindWidth20, setcurrentBlindWidth20] = useState(
    useStateReturnValueFromSessionStrorage("width-20-")
  );
  const [currentBlindDepth20, setcurrentBlindDepth20] = useState(
    useStateReturnValueFromSessionStrorage("depth-20-")
  );
  const [currentBlindWidth21, setcurrentBlindWidth21] = useState(
    useStateReturnValueFromSessionStrorage("width-21-")
  );
  const [currentBlindDepth21, setcurrentBlindDepth21] = useState(
    useStateReturnValueFromSessionStrorage("depth-21-")
  );
  const [currentBlindWidth22, setcurrentBlindWidth22] = useState(
    useStateReturnValueFromSessionStrorage("width-22-")
  );
  const [currentBlindDepth22, setcurrentBlindDepth22] = useState(
    useStateReturnValueFromSessionStrorage("depth-22-")
  );
  const [currentBlindWidth23, setcurrentBlindWidth23] = useState(
    useStateReturnValueFromSessionStrorage("width-23-")
  );
  const [currentBlindDepth23, setcurrentBlindDepth23] = useState(
    useStateReturnValueFromSessionStrorage("depth-23-")
  );
  const [currentBlindWidth24, setcurrentBlindWidth24] = useState(
    useStateReturnValueFromSessionStrorage("width-24-")
  );
  const [currentBlindDepth24, setcurrentBlindDepth24] = useState(
    useStateReturnValueFromSessionStrorage("depth-24-")
  );
  const [currentBlindWidth25, setcurrentBlindWidth25] = useState(
    useStateReturnValueFromSessionStrorage("width-25-")
  );
  const [currentBlindDepth25, setcurrentBlindDepth25] = useState(
    useStateReturnValueFromSessionStrorage("depth-25-")
  );
  const [currentBlindWidth26, setcurrentBlindWidth26] = useState(
    useStateReturnValueFromSessionStrorage("width-26-")
  );
  const [currentBlindDepth26, setcurrentBlindDepth26] = useState(
    useStateReturnValueFromSessionStrorage("depth-26-")
  );
  const [currentBlindWidth27, setcurrentBlindWidth27] = useState(
    useStateReturnValueFromSessionStrorage("width-27-")
  );
  const [currentBlindDepth27, setcurrentBlindDepth27] = useState(
    useStateReturnValueFromSessionStrorage("depth-27-")
  );
  const [currentBlindWidth28, setcurrentBlindWidth28] = useState(
    useStateReturnValueFromSessionStrorage("width-28-")
  );
  const [currentBlindDepth28, setcurrentBlindDepth28] = useState(
    useStateReturnValueFromSessionStrorage("depth-28-")
  );
  const [currentBlindWidth29, setcurrentBlindWidth29] = useState(
    useStateReturnValueFromSessionStrorage("width-29-")
  );
  const [currentBlindDepth29, setcurrentBlindDepth29] = useState(
    useStateReturnValueFromSessionStrorage("depth-29-")
  );
  const [currentBlindWidth30, setcurrentBlindWidth30] = useState(
    useStateReturnValueFromSessionStrorage("width-30-")
  );
  const [currentBlindDepth30, setcurrentBlindDepth30] = useState(
    useStateReturnValueFromSessionStrorage("depth-30-")
  );

  const [currentMotorType, setCurrentMotorType] = useState(
    useStateReturnValueFromSessionStrorage("motor-type-")
  );
  const [currentPowerType, setCurrentPowerType] = useState(
    useStateReturnValueFromSessionStrorage("power-type-")
  );
  const [currentReceiverType, setCurrentReceiverType] = useState(
    useStateReturnValueFromSessionStrorage("receiver-type-")
  );
  const [currentRemoteType, setCurrentRemoteType] = useState(
    useStateReturnValueFromSessionStrorage("remote-type-")
  );
  const [currentOtherType, setCurrentOtherType] = useState(
    useStateReturnValueFromSessionStrorage("other-type-")
  );
  ...
  const [withoutMotorisationTotal10, setWithoutMotorisationTotal10] =
    useState(0);
  const [withoutMotorisationTotal11, setWithoutMotorisationTotal11] =
    useState(0);
  const [withoutMotorisationTotal12, setWithoutMotorisationTotal12] =
    useState(0);
  const [withoutMotorisationTotal13, setWithoutMotorisationTotal13] =
    useState(0);
  const [withoutMotorisationTotal14, setWithoutMotorisationTotal14] =
    useState(0);
  const [withoutMotorisationTotal15, setWithoutMotorisationTotal15] =
    useState(0);
  const [withoutMotorisationTotal16, setWithoutMotorisationTotal16] =
    useState(0);
  const [withoutMotorisationTotal17, setWithoutMotorisationTotal17] =
    useState(0);
  const [withoutMotorisationTotal18, setWithoutMotorisationTotal18] =
    useState(0);
  const [withoutMotorisationTotal19, setWithoutMotorisationTotal19] =
    useState(0);
  const [withoutMotorisationTotal20, setWithoutMotorisationTotal20] =
    useState(0);
  const [withoutMotorisationTotal21, setWithoutMotorisationTotal21] =
    useState(0);
  const [withoutMotorisationTotal22, setWithoutMotorisationTotal22] =
    useState(0);
  const [withoutMotorisationTotal23, setWithoutMotorisationTotal23] =
    useState(0);
  const [withoutMotorisationTotal24, setWithoutMotorisationTotal24] =
    useState(0);
  const [withoutMotorisationTotal25, setWithoutMotorisationTotal25] =
    useState(0);
  const [withoutMotorisationTotal26, setWithoutMotorisationTotal26] =
    useState(0);
  const [withoutMotorisationTotal27, setWithoutMotorisationTotal27] =
    useState(0);
  const [withoutMotorisationTotal28, setWithoutMotorisationTotal28] =
    useState(0);
  const [withoutMotorisationTotal29, setWithoutMotorisationTotal29] =
    useState(0);
  const [withoutMotorisationTotal30, setWithoutMotorisationTotal30] =
    useState(0);
  ...
  const [selectedMotorTypeMultiplier, setSelectedMotorTypeMultiplier] =
    useState(1);
  const [selectedPowerTypeMultiplier, setSelectedPowerTypeMultiplier] =
    useState(1);
  const [selectedReceiverTypeMultiplier, setSelectedReceiverTypeMultiplier] =
    useState(1);
  const [selectedRemoteTypeMultiplier, setSelectedRemoteTypeMultiplier] =
    useState(1);
  const [selectedOtherTypeMultiplier, setSelectedOtherTypeMultiplier] =
    useState(1);
  ...
  const [waitToGetdataFromExcelSheet, setWaitToGetdataFromExcelSheet] =
    useState(true);
  ...
  const setInitialValuesToFormData = async () => {
    ...
    if (getItemFromSessionStorage("width-2-")) {
      setcurrentBlindWidth2(getItemFromSessionStorage("width-2-"));
    }
    if (getItemFromSessionStorage("depth-2-")) {
      setcurrentBlindDepth2(getItemFromSessionStorage("depth-2-"));
    }

    if (getItemFromSessionStorage("width-3-")) {
      setcurrentBlindWidth3(getItemFromSessionStorage("width-3-"));
    }
    if (getItemFromSessionStorage("depth-3-")) {
      setcurrentBlindDepth3(getItemFromSessionStorage("depth-3-"));
    }

    if (getItemFromSessionStorage("width-4-")) {
      setcurrentBlindWidth4(getItemFromSessionStorage("width-4-"));
    }
    if (getItemFromSessionStorage("depth-4-")) {
      setcurrentBlindDepth4(getItemFromSessionStorage("depth-4-"));
    }

    if (getItemFromSessionStorage("width-5-")) {
      setcurrentBlindWidth5(getItemFromSessionStorage("width-5-"));
    }
    if (getItemFromSessionStorage("depth-5-")) {
      setcurrentBlindDepth5(getItemFromSessionStorage("depth-5-"));
    }

    if (getItemFromSessionStorage("width-6-")) {
      setcurrentBlindWidth6(getItemFromSessionStorage("width-6-"));
    }
    if (getItemFromSessionStorage("depth-6-")) {
      setcurrentBlindDepth6(getItemFromSessionStorage("depth-6-"));
    }

    if (getItemFromSessionStorage("width-7-")) {
      setcurrentBlindWidth7(getItemFromSessionStorage("width-7-"));
    }
    if (getItemFromSessionStorage("depth-7-")) {
      setcurrentBlindDepth7(getItemFromSessionStorage("depth-7-"));
    }

    if (getItemFromSessionStorage("width-8-")) {
      setcurrentBlindWidth8(getItemFromSessionStorage("width-8-"));
    }
    if (getItemFromSessionStorage("depth-8-")) {
      setcurrentBlindDepth8(getItemFromSessionStorage("depth-8-"));
    }

    if (getItemFromSessionStorage("width-9-")) {
      setcurrentBlindWidth9(getItemFromSessionStorage("width-9-"));
    }
    if (getItemFromSessionStorage("depth-9-")) {
      setcurrentBlindDepth9(getItemFromSessionStorage("depth-9-"));
    }

    if (getItemFromSessionStorage("width-10-")) {
      setcurrentBlindWidth10(getItemFromSessionStorage("width-10-"));
    }
    if (getItemFromSessionStorage("depth-10-")) {
      setcurrentBlindDepth10(getItemFromSessionStorage("depth-10-"));
    }

    if (getItemFromSessionStorage("width-11-")) {
      setcurrentBlindWidth11(getItemFromSessionStorage("width-11-"));
    }
    if (getItemFromSessionStorage("depth-11-")) {
      setcurrentBlindDepth11(getItemFromSessionStorage("depth-11-"));
    }

    if (getItemFromSessionStorage("width-12-")) {
      setcurrentBlindWidth12(getItemFromSessionStorage("width-12-"));
    }
    if (getItemFromSessionStorage("depth-12-")) {
      setcurrentBlindDepth12(getItemFromSessionStorage("depth-12-"));
    }

    if (getItemFromSessionStorage("width-13-")) {
      setcurrentBlindWidth13(getItemFromSessionStorage("width-13-"));
    }
    if (getItemFromSessionStorage("depth-13-")) {
      setcurrentBlindDepth13(getItemFromSessionStorage("depth-13-"));
    }

    if (getItemFromSessionStorage("width-14-")) {
      setcurrentBlindWidth14(getItemFromSessionStorage("width-14-"));
    }
    if (getItemFromSessionStorage("depth-14-")) {
      setcurrentBlindDepth14(getItemFromSessionStorage("depth-14-"));
    }

    if (getItemFromSessionStorage("width-15-")) {
      setcurrentBlindWidth15(getItemFromSessionStorage("width-15-"));
    }
    if (getItemFromSessionStorage("depth-15-")) {
      setcurrentBlindDepth15(getItemFromSessionStorage("depth-15-"));
    }

    if (getItemFromSessionStorage("width-16-")) {
      setcurrentBlindWidth16(getItemFromSessionStorage("width-16-"));
    }
    if (getItemFromSessionStorage("depth-16-")) {
      setcurrentBlindDepth16(getItemFromSessionStorage("depth-16-"));
    }

    if (getItemFromSessionStorage("width-17-")) {
      setcurrentBlindWidth17(getItemFromSessionStorage("width-17-"));
    }
    if (getItemFromSessionStorage("depth-17-")) {
      setcurrentBlindDepth17(getItemFromSessionStorage("depth-17-"));
    }

    if (getItemFromSessionStorage("width-18-")) {
      setcurrentBlindWidth18(getItemFromSessionStorage("width-18-"));
    }
    if (getItemFromSessionStorage("depth-18-")) {
      setcurrentBlindDepth18(getItemFromSessionStorage("depth-18-"));
    }

    if (getItemFromSessionStorage("width-19-")) {
      setcurrentBlindWidth19(getItemFromSessionStorage("width-19-"));
    }
    if (getItemFromSessionStorage("depth-19-")) {
      setcurrentBlindDepth19(getItemFromSessionStorage("depth-19-"));
    }

    if (getItemFromSessionStorage("width-20-")) {
      setcurrentBlindWidth20(getItemFromSessionStorage("width-20-"));
    }
    if (getItemFromSessionStorage("depth-20-")) {
      setcurrentBlindDepth20(getItemFromSessionStorage("depth-20-"));
    }

    if (getItemFromSessionStorage("width-21-")) {
      setcurrentBlindWidth21(getItemFromSessionStorage("width-21-"));
    }
    if (getItemFromSessionStorage("depth-21-")) {
      setcurrentBlindDepth21(getItemFromSessionStorage("depth-21-"));
    }

    if (getItemFromSessionStorage("width-22-")) {
      setcurrentBlindWidth22(getItemFromSessionStorage("width-22-"));
    }
    if (getItemFromSessionStorage("depth-22-")) {
      setcurrentBlindDepth22(getItemFromSessionStorage("depth-22-"));
    }

    if (getItemFromSessionStorage("width-23-")) {
      setcurrentBlindWidth23(getItemFromSessionStorage("width-23-"));
    }
    if (getItemFromSessionStorage("depth-23-")) {
      setcurrentBlindDepth23(getItemFromSessionStorage("depth-23-"));
    }

    if (getItemFromSessionStorage("width-24-")) {
      setcurrentBlindWidth24(getItemFromSessionStorage("width-24-"));
    }
    if (getItemFromSessionStorage("depth-24-")) {
      setcurrentBlindDepth24(getItemFromSessionStorage("depth-24-"));
    }

    if (getItemFromSessionStorage("width-25-")) {
      setcurrentBlindWidth25(getItemFromSessionStorage("width-25-"));
    }
    if (getItemFromSessionStorage("depth-25-")) {
      setcurrentBlindDepth25(getItemFromSessionStorage("depth-25-"));
    }

    if (getItemFromSessionStorage("width-26-")) {
      setcurrentBlindWidth26(getItemFromSessionStorage("width-26-"));
    }
    if (getItemFromSessionStorage("depth-26-")) {
      setcurrentBlindDepth26(getItemFromSessionStorage("depth-26-"));
    }

    if (getItemFromSessionStorage("width-27-")) {
      setcurrentBlindWidth27(getItemFromSessionStorage("width-27-"));
    }
    if (getItemFromSessionStorage("depth-27-")) {
      setcurrentBlindDepth27(getItemFromSessionStorage("depth-27-"));
    }

    if (getItemFromSessionStorage("width-28-")) {
      setcurrentBlindWidth28(getItemFromSessionStorage("width-28-"));
    }
    if (getItemFromSessionStorage("depth-28-")) {
      setcurrentBlindDepth28(getItemFromSessionStorage("depth-28-"));
    }

    if (getItemFromSessionStorage("width-29-")) {
      setcurrentBlindWidth29(getItemFromSessionStorage("width-29-"));
    }
    if (getItemFromSessionStorage("depth-29-")) {
      setcurrentBlindDepth29(getItemFromSessionStorage("depth-29-"));
    }

    if (getItemFromSessionStorage("width-30-")) {
      setcurrentBlindWidth30(getItemFromSessionStorage("width-30-"));
    }
    if (getItemFromSessionStorage("depth-30-")) {
      setcurrentBlindDepth30(getItemFromSessionStorage("depth-30-"));
    }
    ...
    if (getItemFromSessionStorage("motor-type-multiplier-"))
      setSelectedMotorTypeMultiplier(
        getItemFromSessionStorage("motor-type-multiplier-")
      );

    if (getItemFromSessionStorage("power-type-multiplier-"))
      setSelectedPowerTypeMultiplier(
        getItemFromSessionStorage("power-type-multiplier-")
      );

    if (getItemFromSessionStorage("receiver-type-multiplier-"))
      setSelectedReceiverTypeMultiplier(
        getItemFromSessionStorage("receiver-type-multiplier-")
      );

    if (getItemFromSessionStorage("remote-type-multiplier-"))
      setSelectedRemoteTypeMultiplier(
        getItemFromSessionStorage("remote-type-multiplier-")
      );

    if (getItemFromSessionStorage("other-type-multiplier-"))
      setSelectedOtherTypeMultiplier(
        getItemFromSessionStorage("other-type-multiplier-")
      );

    if (getItemFromSessionStorage("motor-price-"))
      setSelectedMotorTypeExcelValue(
        parseFloat(getItemFromSessionStorage("motor-price-"))
      );

    if (getItemFromSessionStorage("power-price-"))
      setSelectedPowerTypeExcelValue(
        parseFloat(getItemFromSessionStorage("power-price-"))
      );

    if (getItemFromSessionStorage("receiver-price-"))
      setSelectedReceiverTypeExcelValue(
        parseFloat(getItemFromSessionStorage("receiver-price-"))
      );

    if (getItemFromSessionStorage("remote-price-"))
      setSelectedRemoteTypeExcelValue(
        parseFloat(getItemFromSessionStorage("remote-price-"))
      );

    if (getItemFromSessionStorage("other-price-"))
      setSelectedOtherTypeExcelValue(
        parseFloat(getItemFromSessionStorage("other-price-"))
      );
    ...
    if (getItemFromSessionStorage("widthxdepth-2-")) {
      setWidthxDepthRowIndex2(getItemFromSessionStorage("widthxdepth-2-"));
    }
    if (getItemFromSessionStorage("widthxdepth-3-")) {
      setWidthxDepthRowIndex3(getItemFromSessionStorage("widthxdepth-3-"));
    }
    if (getItemFromSessionStorage("widthxdepth-4-")) {
      setWidthxDepthRowIndex4(getItemFromSessionStorage("widthxdepth-4-"));
    }
    if (getItemFromSessionStorage("widthxdepth-5-")) {
      setWidthxDepthRowIndex5(getItemFromSessionStorage("widthxdepth-5-"));
    }
    if (getItemFromSessionStorage("widthxdepth-6-")) {
      setWidthxDepthRowIndex6(getItemFromSessionStorage("widthxdepth-6-"));
    }
    if (getItemFromSessionStorage("widthxdepth-7-")) {
      setWidthxDepthRowIndex7(getItemFromSessionStorage("widthxdepth-7-"));
    }
    if (getItemFromSessionStorage("widthxdepth-8-")) {
      setWidthxDepthRowIndex8(getItemFromSessionStorage("widthxdepth-8-"));
    }
    if (getItemFromSessionStorage("widthxdepth-9-")) {
      setWidthxDepthRowIndex9(getItemFromSessionStorage("widthxdepth-9-"));
    }
    if (getItemFromSessionStorage("widthxdepth-10-")) {
      setWidthxDepthRowIndex10(getItemFromSessionStorage("widthxdepth-10-"));
    }
    if (getItemFromSessionStorage("widthxdepth-11-")) {
      setWidthxDepthRowIndex11(getItemFromSessionStorage("widthxdepth-11-"));
    }
    if (getItemFromSessionStorage("widthxdepth-12-")) {
      setWidthxDepthRowIndex12(getItemFromSessionStorage("widthxdepth-12-"));
    }
    if (getItemFromSessionStorage("widthxdepth-13-")) {
      setWidthxDepthRowIndex13(getItemFromSessionStorage("widthxdepth-13-"));
    }
    if (getItemFromSessionStorage("widthxdepth-14-")) {
      setWidthxDepthRowIndex14(getItemFromSessionStorage("widthxdepth-14-"));
    }
    if (getItemFromSessionStorage("widthxdepth-15-")) {
      setWidthxDepthRowIndex15(getItemFromSessionStorage("widthxdepth-15-"));
    }
    if (getItemFromSessionStorage("widthxdepth-16-")) {
      setWidthxDepthRowIndex16(getItemFromSessionStorage("widthxdepth-16-"));
    }
    if (getItemFromSessionStorage("widthxdepth-17-")) {
      setWidthxDepthRowIndex17(getItemFromSessionStorage("widthxdepth-17-"));
    }
    if (getItemFromSessionStorage("widthxdepth-18-")) {
      setWidthxDepthRowIndex18(getItemFromSessionStorage("widthxdepth-18-"));
    }
    if (getItemFromSessionStorage("widthxdepth-19-")) {
      setWidthxDepthRowIndex19(getItemFromSessionStorage("widthxdepth-19-"));
    }
    if (getItemFromSessionStorage("widthxdepth-20-")) {
      setWidthxDepthRowIndex20(getItemFromSessionStorage("widthxdepth-20-"));
    }
    if (getItemFromSessionStorage("widthxdepth-21-")) {
      setWidthxDepthRowIndex21(getItemFromSessionStorage("widthxdepth-21-"));
    }
    if (getItemFromSessionStorage("widthxdepth-22-")) {
      setWidthxDepthRowIndex22(getItemFromSessionStorage("widthxdepth-22-"));
    }
    if (getItemFromSessionStorage("widthxdepth-23-")) {
      setWidthxDepthRowIndex23(getItemFromSessionStorage("widthxdepth-23-"));
    }
    if (getItemFromSessionStorage("widthxdepth-24-")) {
      setWidthxDepthRowIndex24(getItemFromSessionStorage("widthxdepth-24-"));
    }
    if (getItemFromSessionStorage("widthxdepth-25-")) {
      setWidthxDepthRowIndex25(getItemFromSessionStorage("widthxdepth-25-"));
    }
    if (getItemFromSessionStorage("widthxdepth-26-")) {
      setWidthxDepthRowIndex26(getItemFromSessionStorage("widthxdepth-26-"));
    }
    if (getItemFromSessionStorage("widthxdepth-27-")) {
      setWidthxDepthRowIndex27(getItemFromSessionStorage("widthxdepth-27-"));
    }
    if (getItemFromSessionStorage("widthxdepth-28-")) {
      setWidthxDepthRowIndex28(getItemFromSessionStorage("widthxdepth-28-"));
    }
    if (getItemFromSessionStorage("widthxdepth-29-")) {
      setWidthxDepthRowIndex29(getItemFromSessionStorage("widthxdepth-29-"));
    }
    if (getItemFromSessionStorage("widthxdepth-30-")) {
      setWidthxDepthRowIndex30(getItemFromSessionStorage("widthxdepth-30-"));
    }
    ...
    if (getItemFromSessionStorage("total-")) {
      setWithoutMotorisationTotal(
        parseFloat(getItemFromSessionStorage("total-"))
      );
    }
    // set initial values of WithoutMotorisationTotal repeat from 2nd :
    if (getItemFromSessionStorage("total-2-")) {
      setWithoutMotorisationTotal2(
        parseFloat(getItemFromSessionStorage("total-2-"))
      );
    }
    if (getItemFromSessionStorage("total-3-")) {
      setWithoutMotorisationTotal3(
        parseFloat(getItemFromSessionStorage("total-3-"))
      );
    }
    if (getItemFromSessionStorage("total-4-")) {
      setWithoutMotorisationTotal4(
        parseFloat(getItemFromSessionStorage("total-4-"))
      );
    }
    if (getItemFromSessionStorage("total-5-")) {
      setWithoutMotorisationTotal5(
        parseFloat(getItemFromSessionStorage("total-5-"))
      );
    }
    if (getItemFromSessionStorage("total-6-")) {
      setWithoutMotorisationTotal6(
        parseFloat(getItemFromSessionStorage("total-6-"))
      );
    }
    if (getItemFromSessionStorage("total-7-")) {
      setWithoutMotorisationTotal7(
        parseFloat(getItemFromSessionStorage("total-7-"))
      );
    }
    if (getItemFromSessionStorage("total-8-")) {
      setWithoutMotorisationTotal8(
        parseFloat(getItemFromSessionStorage("total-8-"))
      );
    }
    if (getItemFromSessionStorage("total-9-")) {
      setWithoutMotorisationTotal9(
        parseFloat(getItemFromSessionStorage("total-9-"))
      );
    }
    if (getItemFromSessionStorage("total-10-")) {
      setWithoutMotorisationTotal10(
        parseFloat(getItemFromSessionStorage("total-10-"))
      );
    }
    if (getItemFromSessionStorage("total-11-")) {
      setWithoutMotorisationTotal11(
        parseFloat(getItemFromSessionStorage("total-11-"))
      );
    }
    if (getItemFromSessionStorage("total-12-")) {
      setWithoutMotorisationTotal12(
        parseFloat(getItemFromSessionStorage("total-12-"))
      );
    }
    if (getItemFromSessionStorage("total-13-")) {
      setWithoutMotorisationTotal13(
        parseFloat(getItemFromSessionStorage("total-13-"))
      );
    }
    if (getItemFromSessionStorage("total-14-")) {
      setWithoutMotorisationTotal14(
        parseFloat(getItemFromSessionStorage("total-14-"))
      );
    }
    if (getItemFromSessionStorage("total-15-")) {
      setWithoutMotorisationTotal15(
        parseFloat(getItemFromSessionStorage("total-15-"))
      );
    }
    if (getItemFromSessionStorage("total-16-")) {
      setWithoutMotorisationTotal16(
        parseFloat(getItemFromSessionStorage("total-16-"))
      );
    }
    if (getItemFromSessionStorage("total-17-")) {
      setWithoutMotorisationTotal17(
        parseFloat(getItemFromSessionStorage("total-17-"))
      );
    }
    if (getItemFromSessionStorage("total-18-")) {
      setWithoutMotorisationTotal18(
        parseFloat(getItemFromSessionStorage("total-18-"))
      );
    }
    if (getItemFromSessionStorage("total-19-")) {
      setWithoutMotorisationTotal19(
        parseFloat(getItemFromSessionStorage("total-19-"))
      );
    }
    if (getItemFromSessionStorage("total-20-")) {
      setWithoutMotorisationTotal20(
        parseFloat(getItemFromSessionStorage("total-20-"))
      );
    }
    if (getItemFromSessionStorage("total-21-")) {
      setWithoutMotorisationTotal21(
        parseFloat(getItemFromSessionStorage("total-21-"))
      );
    }
    if (getItemFromSessionStorage("total-22-")) {
      setWithoutMotorisationTotal22(
        parseFloat(getItemFromSessionStorage("total-22-"))
      );
    }
    if (getItemFromSessionStorage("total-23-")) {
      setWithoutMotorisationTotal23(
        parseFloat(getItemFromSessionStorage("total-23-"))
      );
    }
    if (getItemFromSessionStorage("total-24-")) {
      setWithoutMotorisationTotal24(
        parseFloat(getItemFromSessionStorage("total-24-"))
      );
    }
    if (getItemFromSessionStorage("total-25-")) {
      setWithoutMotorisationTotal25(
        parseFloat(getItemFromSessionStorage("total-25-"))
      );
    }
    if (getItemFromSessionStorage("total-26-")) {
      setWithoutMotorisationTotal26(
        parseFloat(getItemFromSessionStorage("total-26-"))
      );
    }
    if (getItemFromSessionStorage("total-27-")) {
      setWithoutMotorisationTotal27(
        parseFloat(getItemFromSessionStorage("total-27-"))
      );
    }
    if (getItemFromSessionStorage("total-28-")) {
      setWithoutMotorisationTotal28(
        parseFloat(getItemFromSessionStorage("total-28-"))
      );
    }
    if (getItemFromSessionStorage("total-29-")) {
      setWithoutMotorisationTotal29(
        parseFloat(getItemFromSessionStorage("total-29-"))
      );
    }
    if (getItemFromSessionStorage("total-30-")) {
      setWithoutMotorisationTotal30(
        parseFloat(getItemFromSessionStorage("total-30-"))
      );
    }

    if (
      sessionStorage.getItem("blind-type-" + blindNumber) === "" ||
      sessionStorage.getItem("blind-type-" + blindNumber) === null
    ) {
    ...
    if (
      getItemFromSessionStorage("blind-type") ||
      getItemFromSessionStorage("fabric-type") ||
      currentFabricTypes
    ) {
      blindBandChooser(
        getItemFromSessionStorage("blind-type"),
  ...
  const fetchExcelSheetData = async () => {
    await fetch(
      ...
      .then((data) => {
        ...
        console.log(
          "%c Excel Data fetch sucefully! ",
          'background: #dcfce7; color: #14532d; font: 1.3em "Fira Sans", sans-serif;'
        );
      })
      .catch(() => {
        setWaitToGetdataFromExcelSheet(false);
        console.log(
          "%c Excel Data fetching *Failed*! ",
          'background: #fecaca; color: #991b1b; font: 1.5em "Fira Sans", sans-serif;'
        );
      });
  };
  ...
  useEffect(() => {
    ...
    if (
      ...
      sessionStorage.getItem("blind-type-" + blindNumber) === "Perfect Fit"
    ) {
  ...
  async function handleBlindChangeInput(e) {
    ...
    setcurrentBlindWidth5("");
    sessionStorage.removeItem("width-5-" + blindNumber);
    setcurrentBlindWidth6("");
    sessionStorage.removeItem("width-6-" + blindNumber);
    setcurrentBlindWidth7("");
    sessionStorage.removeItem("width-7-" + blindNumber);
    setcurrentBlindWidth8("");
    sessionStorage.removeItem("width-8-" + blindNumber);
    setcurrentBlindWidth9("");
    sessionStorage.removeItem("width-9-" + blindNumber);
    setcurrentBlindWidth10("");
    sessionStorage.removeItem("width-10-" + blindNumber);
    setcurrentBlindWidth11("");
    sessionStorage.removeItem("width-11-" + blindNumber);
    setcurrentBlindWidth12("");
    sessionStorage.removeItem("width-12-" + blindNumber);
    setcurrentBlindWidth13("");
    sessionStorage.removeItem("width-13-" + blindNumber);
    setcurrentBlindWidth14("");
    sessionStorage.removeItem("width-14-" + blindNumber);
    setcurrentBlindWidth15("");
    sessionStorage.removeItem("width-15-" + blindNumber);
    setcurrentBlindWidth16("");
    sessionStorage.removeItem("width-16-" + blindNumber);
    setcurrentBlindWidth17("");
    sessionStorage.removeItem("width-17-" + blindNumber);
    setcurrentBlindWidth18("");
    sessionStorage.removeItem("width-18-" + blindNumber);
    setcurrentBlindWidth19("");
    sessionStorage.removeItem("width-19-" + blindNumber);
    setcurrentBlindWidth20("");
    sessionStorage.removeItem("width-20-" + blindNumber);
    setcurrentBlindWidth21("");
    sessionStorage.removeItem("width-21-" + blindNumber);
    setcurrentBlindWidth22("");
    sessionStorage.removeItem("width-22-" + blindNumber);
    setcurrentBlindWidth23("");
    sessionStorage.removeItem("width-23-" + blindNumber);
    setcurrentBlindWidth24("");
    sessionStorage.removeItem("width-24-" + blindNumber);
    setcurrentBlindWidth25("");
    sessionStorage.removeItem("width-25-" + blindNumber);
    setcurrentBlindWidth26("");
    sessionStorage.removeItem("width-26-" + blindNumber);
    setcurrentBlindWidth27("");
    sessionStorage.removeItem("width-27-" + blindNumber);
    setcurrentBlindWidth28("");
    sessionStorage.removeItem("width-28-" + blindNumber);
    setcurrentBlindWidth29("");
    sessionStorage.removeItem("width-29-" + blindNumber);
    setcurrentBlindWidth30("");
    sessionStorage.removeItem("width-30-" + blindNumber);
    ...
    setcurrentBlindDepth5("");
    sessionStorage.removeItem("depth-5-" + blindNumber);
    setcurrentBlindDepth6("");
    sessionStorage.removeItem("depth-6-" + blindNumber);
    setcurrentBlindDepth7("");
    sessionStorage.removeItem("depth-7-" + blindNumber);
    setcurrentBlindDepth8("");
    sessionStorage.removeItem("depth-8-" + blindNumber);
    setcurrentBlindDepth9("");
    sessionStorage.removeItem("depth-9-" + blindNumber);
    setcurrentBlindDepth10("");
    sessionStorage.removeItem("depth-10-" + blindNumber);
    setcurrentBlindDepth11("");
    sessionStorage.removeItem("depth-11-" + blindNumber);
    setcurrentBlindDepth12("");
    sessionStorage.removeItem("depth-12-" + blindNumber);
    setcurrentBlindDepth13("");
    sessionStorage.removeItem("depth-13-" + blindNumber);
    setcurrentBlindDepth14("");
    sessionStorage.removeItem("depth-14-" + blindNumber);
    setcurrentBlindDepth15("");
    sessionStorage.removeItem("depth-15-" + blindNumber);
    setcurrentBlindDepth16("");
    sessionStorage.removeItem("depth-16-" + blindNumber);
    setcurrentBlindDepth17("");
    sessionStorage.removeItem("depth-17-" + blindNumber);
    setcurrentBlindDepth18("");
    sessionStorage.removeItem("depth-18-" + blindNumber);
    setcurrentBlindDepth19("");
    sessionStorage.removeItem("depth-19-" + blindNumber);
    setcurrentBlindDepth20("");
    sessionStorage.removeItem("depth-20-" + blindNumber);
    setcurrentBlindDepth21("");
    sessionStorage.removeItem("depth-21-" + blindNumber);
    setcurrentBlindDepth22("");
    sessionStorage.removeItem("depth-22-" + blindNumber);
    setcurrentBlindDepth23("");
    sessionStorage.removeItem("depth-23-" + blindNumber);
    setcurrentBlindDepth24("");
    sessionStorage.removeItem("depth-24-" + blindNumber);
    setcurrentBlindDepth25("");
    sessionStorage.removeItem("depth-25-" + blindNumber);
    setcurrentBlindDepth26("");
    sessionStorage.removeItem("depth-26-" + blindNumber);
    setcurrentBlindDepth27("");
    sessionStorage.removeItem("depth-27-" + blindNumber);
    setcurrentBlindDepth28("");
    sessionStorage.removeItem("depth-28-" + blindNumber);
    setcurrentBlindDepth29("");
    sessionStorage.removeItem("depth-29-" + blindNumber);
    setcurrentBlindDepth30("");
    sessionStorage.removeItem("depth-30-" + blindNumber);
  ...
  async function handleFabricChangeInput(e) {
    ...
    if (e.target.value) {
      ...
      setItemValueInSessionStorageKey(
        "band-type-",
        blindBandChooser(currentBlindType, e.target.value, currentFabricTypes)
      );
    } else {
  ...
  async function handleMotorTypeChangeInput(e) {
    ...
    if (e.target.value === "") {
      ...
      setSelectedMotorTypeExcelValue(
        excelData[motorTypes.indexOf(e.target.value)].Motor
      );
      setItemValueInSessionStorageKey(
        "motor-price-",
        parseFloat(excelData[motorTypes.indexOf(e.target.value)].Motor)
      );
    }
  }
  ...
  async function handlePowerTypeChangeInput(e) {
    ...
    if (e.target.value === "") {
      ...
      setItemValueInSessionStorageKey(
        "power-price-",
        parseFloat(excelData[powerOptions.indexOf(e.target.value)].Power)
      );
      setSelectedPowerTypeExcelValue(
        excelData[powerOptions.indexOf(e.target.value)].Power
      );
    }
  }
  ...
  async function handleReceiverTypeChangeInput(e) {
    ...
    if (e.target.value === "") {
      ...
      setItemValueInSessionStorageKey(
        "receiver-price-",
        parseFloat(excelData[receiverOptions.indexOf(e.target.value)].Receiver)
      );
      setSelectedReceiverTypeExcelValue(
        excelData[receiverOptions.indexOf(e.target.value)].Receiver
      );
    }
  }
  ...
  async function handleRemoteTypeChangeInput(e) {
    ...
    if (e.target.value === "") {
      ...
      setItemValueInSessionStorageKey(
        "remote-price-",
        parseFloat(excelData[remoteOptions.indexOf(e.target.value)].Remote)
      );
      setSelectedRemoteTypeExcelValue(
        excelData[remoteOptions.indexOf(e.target.value)].Remote
      );
    }
  }
  ...
  async function handleOtherTypeChangeInput(e) {
    ...
    if (e.target.value === "") {
      ...
      setItemValueInSessionStorageKey(
        "other-price-",
        parseFloat(excelData[otherOptions.indexOf(e.target.value)].Other)
      );
      setSelectedOtherTypeExcelValue(
        excelData[otherOptions.indexOf(e.target.value)].Other
      );
    }
  }
  ...
  const selectedMotorTypeMultiplierHandler = (e) => {
    ...
    sessionStorage.setItem(
      "motor-type-multiplier-" + blindNumber,
      checkNumberShouldApply(e.target.value)
    );
  ...
  const selectedPowerTypeMultiplierHandler = (e) => {
    ...
    sessionStorage.setItem(
      "power-type-multiplier-" + blindNumber,
      checkNumberShouldApply(e.target.value)
    );
  ...
  const selectedReceiverTypeMultiplierHandler = (e) => {
    ...
    sessionStorage.setItem(
      "receiver-type-multiplier-" + blindNumber,
      checkNumberShouldApply(e.target.value)
    );
  ...
  const selectedRemoteTypeMultiplierHandler = (e) => {
    ...
    sessionStorage.setItem(
      "remote-type-multiplier-" + blindNumber,
      checkNumberShouldApply(e.target.value)
    );
  ...
  const selectedOtherTypeMultiplierHandler = (e) => {
    ...
    sessionStorage.setItem(
      "other-type-multiplier-" + blindNumber,
      checkNumberShouldApply(e.target.value)
    );
  ...
  function refreshBtnListner() {
    ...
    setWithoutMotorisationTotal2(0);
    removeItemFromSessionStorage("total-2-");
    setWithoutMotorisationTotal3(0);
    removeItemFromSessionStorage("total-3-");
    setWithoutMotorisationTotal4(0);
    removeItemFromSessionStorage("total-4-");
    setWithoutMotorisationTotal5(0);
    removeItemFromSessionStorage("total-5-");
    setWithoutMotorisationTotal6(0);
    removeItemFromSessionStorage("total-6-");
    setWithoutMotorisationTotal7(0);
    removeItemFromSessionStorage("total-7-");
    setWithoutMotorisationTotal8(0);
    removeItemFromSessionStorage("total-8-");
    setWithoutMotorisationTotal9(0);
    removeItemFromSessionStorage("total-9-");
    setWithoutMotorisationTotal10(0);
    removeItemFromSessionStorage("total-10-");
    setWithoutMotorisationTotal11(0);
    removeItemFromSessionStorage("total-11-");
    setWithoutMotorisationTotal12(0);
    removeItemFromSessionStorage("total-12-");
    setWithoutMotorisationTotal13(0);
    removeItemFromSessionStorage("total-13-");
    setWithoutMotorisationTotal14(0);
    removeItemFromSessionStorage("total-14-");
    setWithoutMotorisationTotal15(0);
    removeItemFromSessionStorage("total-15-");
    setWithoutMotorisationTotal16(0);
    removeItemFromSessionStorage("total-16-");
    setWithoutMotorisationTotal17(0);
    removeItemFromSessionStorage("total-17-");
    setWithoutMotorisationTotal18(0);
    removeItemFromSessionStorage("total-18-");
    setWithoutMotorisationTotal19(0);
    removeItemFromSessionStorage("total-19-");
    setWithoutMotorisationTotal20(0);
    removeItemFromSessionStorage("total-20-");
    setWithoutMotorisationTotal21(0);
    removeItemFromSessionStorage("total-21-");
    setWithoutMotorisationTotal22(0);
    removeItemFromSessionStorage("total-22-");
    setWithoutMotorisationTotal23(0);
    removeItemFromSessionStorage("total-23-");
    setWithoutMotorisationTotal24(0);
    removeItemFromSessionStorage("total-24-");
    setWithoutMotorisationTotal25(0);
    removeItemFromSessionStorage("total-25-");
    setWithoutMotorisationTotal26(0);
    removeItemFromSessionStorage("total-26-");
    setWithoutMotorisationTotal27(0);
    removeItemFromSessionStorage("total-27-");
    setWithoutMotorisationTotal28(0);
    removeItemFromSessionStorage("total-28-");
    setWithoutMotorisationTotal29(0);
    removeItemFromSessionStorage("total-29-");
    setWithoutMotorisationTotal30(0);
    removeItemFromSessionStorage("total-30-");
  ...
  const blindBandChooser = (blindType, fabricType, fabricArr) => {
    ...
    if (blindType === "Freehang") {
      ...
      setItemValueInSessionStorageKey(
        "band-type-",
        freehangBandChooser(fabricArr.indexOf(fabricType) + 1)
      );
      ...
      setItemValueInSessionStorageKey(
        "band-type-",
        threeBarsBandChooser(fabricArr.indexOf(fabricType) + 1)
      );
      ...
      setItemValueInSessionStorageKey(
        "band-type-",
        perfectFitBandChooser(fabricArr.indexOf(fabricType) + 1)
      );
      ...
      setItemValueInSessionStorageKey(
        "band-type-",
        lanternBandChooser(fabricArr.indexOf(fabricType) + 1)
      );
  ...
  function widthxDepthRowNumber(blindType, width, depth, elementNo) {
    ...
    if (elementNo === 1) {
      if (blindType === "Freehang") {
        ...
        return motorizedFreeHangWidthxDepthColumnData.indexOf(
          width + "x" + depth
        );
      } else if (blindType === "Three Bars") {
        setWidthxDepthRowIndex(
  ...
  const calculate = async () => {
    ...
    let myPromise = new Promise(function (myResolve, myReject) {
      if (currentBlindWidth && currentBlindDepth) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth,
          currentBlindDepth,
      ...
      if (currentBlindWidth2 && currentBlindDepth2) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth2,
          currentBlindDepth2,
      ...
      if (currentBlindWidth3 && currentBlindDepth3) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth3,
          currentBlindDepth3,
      ...
      if (currentBlindWidth4 && currentBlindDepth4) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth4,
          currentBlindDepth4,
      ...
      if (currentBlindWidth5 && currentBlindDepth5) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth5,
          currentBlindDepth5,
      ...
      if (currentBlindWidth6 && currentBlindDepth6) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth6,
          currentBlindDepth6,
      ...
      if (currentBlindWidth7 && currentBlindDepth7) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth7,
          currentBlindDepth7,
      ...
      if (currentBlindWidth8 && currentBlindDepth8) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth8,
          currentBlindDepth8,
      ...
      if (currentBlindWidth9 && currentBlindDepth9) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth9,
          currentBlindDepth9,
      ...
      if (currentBlindWidth10 && currentBlindDepth10) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth10,
          currentBlindDepth10,
      ...
      if (currentBlindWidth11 && currentBlindDepth11) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth11,
          currentBlindDepth11,
      ...
      if (currentBlindWidth12 && currentBlindDepth12) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth12,
          currentBlindDepth12,
      ...
      if (currentBlindWidth13 && currentBlindDepth13) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth13,
          currentBlindDepth13,
      ...
      if (currentBlindWidth14 && currentBlindDepth14) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth14,
          currentBlindDepth14,
      ...
      if (currentBlindWidth15 && currentBlindDepth15) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth15,
          currentBlindDepth15,
      ...
      if (currentBlindWidth16 && currentBlindDepth16) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth16,
          currentBlindDepth16,
      ...
      if (currentBlindWidth17 && currentBlindDepth17) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth17,
          currentBlindDepth17,
      ...
      if (currentBlindWidth18 && currentBlindDepth18) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth18,
          currentBlindDepth18,
      ...
      if (currentBlindWidth19 && currentBlindDepth19) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth19,
          currentBlindDepth19,
      ...
      if (currentBlindWidth20 && currentBlindDepth20) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth20,
          currentBlindDepth20,
      ...
      if (currentBlindWidth21 && currentBlindDepth21) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth21,
          currentBlindDepth21,
      ...
      if (currentBlindWidth22 && currentBlindDepth22) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth22,
          currentBlindDepth22,
      ...
      if (currentBlindWidth23 && currentBlindDepth23) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth23,
          currentBlindDepth23,
      ...
      if (currentBlindWidth24 && currentBlindDepth24) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth24,
          currentBlindDepth24,
      ...
      if (currentBlindWidth25 && currentBlindDepth25) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth25,
          currentBlindDepth25,
      ...
      if (currentBlindWidth26 && currentBlindDepth26) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth26,
          currentBlindDepth26,
      ...
      if (currentBlindWidth27 && currentBlindDepth27) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth27,
          currentBlindDepth27,
      ...
      if (currentBlindWidth28 && currentBlindDepth28) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth28,
          currentBlindDepth28,
      ...
      if (currentBlindWidth29 && currentBlindDepth29) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth29,
          currentBlindDepth29,
      ...
      if (currentBlindWidth30 && currentBlindDepth30) {
        widthxDepthRowNumber(
          currentBlindType,
          currentBlindWidth30,
          currentBlindDepth30,
    ...
    myPromise.then(
      function () {
        ...
        console.log(
          widthxDepthRowIndex,
          " ",
          widthxDepthRowIndex2,
          " ",
          widthxDepthRowIndex3,
          " ",
          widthxDepthRowIndex4
        );
        ...
        if (widthxDepthRowIndex) {
          ...
          setItemValueInSessionStorageKey(
            "total-",
            parseFloat(excelData[widthxDepthRowIndex][bandType])
          );
        }
        // repeat to calculate setWithoutMotorisationTotal from 2nd
        if (widthxDepthRowIndex2) {
          setWithoutMotorisationTotal2(
            excelData[widthxDepthRowIndex2][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-2-",
            parseFloat(excelData[widthxDepthRowIndex2][bandType])
          );
        }
        if (widthxDepthRowIndex3) {
          setWithoutMotorisationTotal3(
            excelData[widthxDepthRowIndex3][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-3-",
            parseFloat(excelData[widthxDepthRowIndex3][bandType])
          );
        }
        if (widthxDepthRowIndex4) {
          setWithoutMotorisationTotal4(
            excelData[widthxDepthRowIndex4][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-4-",
            parseFloat(excelData[widthxDepthRowIndex4][bandType])
          );
        }
        if (widthxDepthRowIndex5) {
          setWithoutMotorisationTotal5(
            excelData[widthxDepthRowIndex5][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-5-",
            parseFloat(excelData[widthxDepthRowIndex5][bandType])
          );
        }
        if (widthxDepthRowIndex6) {
          setWithoutMotorisationTotal6(
            excelData[widthxDepthRowIndex6][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-6-",
            parseFloat(excelData[widthxDepthRowIndex6][bandType])
          );
        }
        if (widthxDepthRowIndex7) {
          setWithoutMotorisationTotal7(
            excelData[widthxDepthRowIndex7][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-7-",
            parseFloat(excelData[widthxDepthRowIndex7][bandType])
          );
        }
        if (widthxDepthRowIndex8) {
          setWithoutMotorisationTotal8(
            excelData[widthxDepthRowIndex8][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-8-",
            parseFloat(excelData[widthxDepthRowIndex8][bandType])
          );
        }
        if (widthxDepthRowIndex9) {
          setWithoutMotorisationTotal9(
            excelData[widthxDepthRowIndex9][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-9-",
            parseFloat(excelData[widthxDepthRowIndex9][bandType])
          );
        }
        if (widthxDepthRowIndex10) {
          setWithoutMotorisationTotal10(
            excelData[widthxDepthRowIndex10][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-10-",
            parseFloat(excelData[widthxDepthRowIndex10][bandType])
          );
        }
        if (widthxDepthRowIndex11) {
          setWithoutMotorisationTotal11(
            excelData[widthxDepthRowIndex11][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-11-",
            parseFloat(excelData[widthxDepthRowIndex11][bandType])
          );
        }
        if (widthxDepthRowIndex12) {
          setWithoutMotorisationTotal12(
            excelData[widthxDepthRowIndex12][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-12-",
            parseFloat(excelData[widthxDepthRowIndex12][bandType])
          );
        }
        if (widthxDepthRowIndex13) {
          setWithoutMotorisationTotal13(
            excelData[widthxDepthRowIndex13][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-13-",
            parseFloat(excelData[widthxDepthRowIndex13][bandType])
          );
        }
        if (widthxDepthRowIndex14) {
          setWithoutMotorisationTotal14(
            excelData[widthxDepthRowIndex14][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-14-",
            parseFloat(excelData[widthxDepthRowIndex14][bandType])
          );
        }
        if (widthxDepthRowIndex15) {
          setWithoutMotorisationTotal15(
            excelData[widthxDepthRowIndex15][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-15-",
            parseFloat(excelData[widthxDepthRowIndex15][bandType])
          );
        }
        if (widthxDepthRowIndex16) {
          setWithoutMotorisationTotal16(
            excelData[widthxDepthRowIndex16][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-16-",
            parseFloat(excelData[widthxDepthRowIndex16][bandType])
          );
        }
        if (widthxDepthRowIndex17) {
          setWithoutMotorisationTotal17(
            excelData[widthxDepthRowIndex17][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-17-",
            parseFloat(excelData[widthxDepthRowIndex17][bandType])
          );
        }
        if (widthxDepthRowIndex18) {
          setWithoutMotorisationTotal18(
            excelData[widthxDepthRowIndex18][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-18-",
            parseFloat(excelData[widthxDepthRowIndex18][bandType])
          );
        }
        if (widthxDepthRowIndex19) {
          setWithoutMotorisationTotal19(
            excelData[widthxDepthRowIndex19][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-19-",
            parseFloat(excelData[widthxDepthRowIndex19][bandType])
          );
        }
        if (widthxDepthRowIndex20) {
          setWithoutMotorisationTotal20(
            excelData[widthxDepthRowIndex20][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-20-",
            parseFloat(excelData[widthxDepthRowIndex20][bandType])
          );
        }
        if (widthxDepthRowIndex21) {
          setWithoutMotorisationTotal21(
            excelData[widthxDepthRowIndex21][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-21-",
            parseFloat(excelData[widthxDepthRowIndex21][bandType])
          );
        }
        if (widthxDepthRowIndex22) {
          setWithoutMotorisationTotal22(
            excelData[widthxDepthRowIndex22][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-22-",
            parseFloat(excelData[widthxDepthRowIndex22][bandType])
          );
        }
        if (widthxDepthRowIndex23) {
          setWithoutMotorisationTotal23(
            excelData[widthxDepthRowIndex23][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-23-",
            parseFloat(excelData[widthxDepthRowIndex23][bandType])
          );
        }
        if (widthxDepthRowIndex24) {
          setWithoutMotorisationTotal24(
            excelData[widthxDepthRowIndex24][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-24-",
            parseFloat(excelData[widthxDepthRowIndex24][bandType])
          );
        }
        if (widthxDepthRowIndex25) {
          setWithoutMotorisationTotal25(
            excelData[widthxDepthRowIndex25][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-25-",
            parseFloat(excelData[widthxDepthRowIndex25][bandType])
          );
        }
        if (widthxDepthRowIndex26) {
          setWithoutMotorisationTotal26(
            excelData[widthxDepthRowIndex26][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-26-",
            parseFloat(excelData[widthxDepthRowIndex26][bandType])
          );
        }
        if (widthxDepthRowIndex27) {
          setWithoutMotorisationTotal27(
            excelData[widthxDepthRowIndex27][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-27-",
            parseFloat(excelData[widthxDepthRowIndex27][bandType])
          );
        }
        if (widthxDepthRowIndex28) {
          setWithoutMotorisationTotal28(
            excelData[widthxDepthRowIndex28][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-28-",
            parseFloat(excelData[widthxDepthRowIndex28][bandType])
          );
        }
        if (widthxDepthRowIndex29) {
          setWithoutMotorisationTotal29(
            excelData[widthxDepthRowIndex29][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-29-",
            parseFloat(excelData[widthxDepthRowIndex29][bandType])
          );
        }
        if (widthxDepthRowIndex30) {
          setWithoutMotorisationTotal30(
            excelData[widthxDepthRowIndex30][bandType]
          );
          setItemValueInSessionStorageKey(
            "total-30-",
            parseFloat(excelData[widthxDepthRowIndex30][bandType])
          );
        }
  ...
  return !waitToGetdataFromExcelSheet ? (
    <>
      ...
      <button
        ...
        className="mt-2 w-full flex mx-auto  text-gray-500 bg-lime-50 border-2 px-3 py-2 rounded-lg text-base justify-center font-semibold text-center"
      >
      ...
      <button
        className="mt-3 w-full flex mx-auto  text-gray-500 bg-lime-50 border-2 px-3 py-2 rounded-lg text-base justify-center font-semibold text-center"
      ...
      >
        <div className="flex justify-center items-center text-sm sm:text-base  gap-4">
          {isCalculating && (
            <svg
              role="status"
              className="w-5 h-5  text-gray-200 animate-spin dark:text-white fill-sky-900"
              viewBox="0 0 100 101"
              fill="none"
      ...
      {motorisationToggle && (
        <div className="px-2 flex flex-col justify-center rounded shadow-sm mt-2.5 text-center bg-sky-100">
          ...
          <div className="grid grid-cols-3 px-2 justify-between text-center">
            ...
            <h1 className="p-2 font-semibold text-base sm:text-md text-sky-900">
              {selectedMotorTypeMultiplier &&
              selectedMotorTypeExcelValue >= 0 ? (
                <>
                  £{" "}
                  {parseFloat(
                    selectedMotorTypeExcelValue * selectedMotorTypeMultiplier
                  ).toFixed(2)}
                </>
              ) : (
                <>£ {parseFloat(selectedMotorTypeExcelValue).toFixed(2)}</>
          ...
          <div className="grid grid-cols-3 px-2 justify-between text-center">
            ...
            <h1 className="p-2 font-semibold text-base sm:text-md text-sky-900">
              {selectedPowerTypeMultiplier &&
              selectedPowerTypeExcelValue >= 0 ? (
                <>
                  £{" "}
                  {parseFloat(
                    selectedPowerTypeExcelValue * selectedPowerTypeMultiplier
                  ).toFixed(2)}
                </>
              ) : (
                <>£ {parseFloat(selectedPowerTypeExcelValue).toFixed(2)}</>
          ...
          <div className="grid grid-cols-3 px-2 justify-between text-center">
            ...
            <h1 className="p-2 font-semibold text-base sm:text-md text-sky-900">
              {selectedReceiverTypeMultiplier &&
              selectedReceiverTypeExcelValue >= 0 ? (
                <>
                  £{" "}
                  {parseFloat(
          ...
          <div className="grid grid-cols-3 px-2 justify-between text-center">
            ...
            <h1 className="p-2 font-semibold text-base sm:text-md text-sky-900">
              {selectedRemoteTypeMultiplier &&
              selectedRemoteTypeExcelValue >= 0 ? (
                <>
                  £{" "}
                  {parseFloat(
                    selectedRemoteTypeExcelValue * selectedRemoteTypeMultiplier
                  ).toFixed(2)}
                </>
              ) : (
                <>£ {parseFloat(selectedRemoteTypeExcelValue).toFixed(2)}</>
          ...
          <div className="grid grid-cols-3 px-2 justify-between text-center">
            ...
            <h1 className="p-2 font-semibold text-base sm:text-md text-sky-900">
              {selectedOtherTypeMultiplier &&
              selectedOtherTypeExcelValue >= 0 ? (
                <>
                  £{" "}
                  {parseFloat(
                    selectedOtherTypeExcelValue * selectedOtherTypeMultiplier
                  ).toFixed(2)}
                </>
              ) : (
                <>£ {parseFloat(selectedOtherTypeExcelValue).toFixed(2)}</>
      ...
      <div className=" flex flex-col px-2  justify-center rounded shadow-sm mt-2.5 text-center bg-sky-100">
        ...
        <div className="">
          <ShowBothTotalBelowButton
            elementNo={1}
            hideBottomBorder={false}
            total={withoutMotorisationTotal}
            grandTotal={
              currentBlindWidth && currentBlindDepth
                ? parseFloat(
                    withoutMotorisationTotal +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={2}
            total={withoutMotorisationTotal2}
            grandTotal={
              currentBlindWidth2 && currentBlindDepth2
                ? parseFloat(
                    withoutMotorisationTotal2 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={3}
            total={withoutMotorisationTotal3}
            grandTotal={
              currentBlindWidth3 && currentBlindDepth3
                ? parseFloat(
                    withoutMotorisationTotal3 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={4}
            total={withoutMotorisationTotal4}
            grandTotal={
              currentBlindWidth4 && currentBlindDepth4
                ? parseFloat(
                    withoutMotorisationTotal4 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={5}
            total={withoutMotorisationTotal5}
            grandTotal={
              currentBlindWidth5 && currentBlindDepth5
                ? parseFloat(
                    withoutMotorisationTotal5 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={6}
            total={withoutMotorisationTotal6}
            grandTotal={
              currentBlindWidth6 && currentBlindDepth6
                ? parseFloat(
                    withoutMotorisationTotal6 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={7}
            total={withoutMotorisationTotal7}
            grandTotal={
              currentBlindWidth7 && currentBlindDepth7
                ? parseFloat(
                    withoutMotorisationTotal7 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={8}
            total={withoutMotorisationTotal8}
            grandTotal={
              currentBlindWidth8 && currentBlindDepth8
                ? parseFloat(
                    withoutMotorisationTotal8 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={9}
            total={withoutMotorisationTotal9}
            grandTotal={
              currentBlindWidth9 && currentBlindDepth9
                ? parseFloat(
                    withoutMotorisationTotal9 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={10}
            total={withoutMotorisationTotal10}
            grandTotal={
              currentBlindWidth10 && currentBlindDepth10
                ? parseFloat(
                    withoutMotorisationTotal10 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={11}
            total={withoutMotorisationTotal11}
            grandTotal={
              currentBlindWidth11 && currentBlindDepth11
                ? parseFloat(
                    withoutMotorisationTotal11 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={12}
            total={withoutMotorisationTotal12}
            grandTotal={
              currentBlindWidth12 && currentBlindDepth12
                ? parseFloat(
                    withoutMotorisationTotal12 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={13}
            total={withoutMotorisationTotal13}
            grandTotal={
              currentBlindWidth13 && currentBlindDepth13
                ? parseFloat(
                    withoutMotorisationTotal13 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={14}
            total={withoutMotorisationTotal14}
            grandTotal={
              currentBlindWidth14 && currentBlindDepth14
                ? parseFloat(
                    withoutMotorisationTotal14 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={15}
            total={withoutMotorisationTotal15}
            grandTotal={
              currentBlindWidth15 && currentBlindDepth15
                ? parseFloat(
                    withoutMotorisationTotal15 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={16}
            total={withoutMotorisationTotal16}
            grandTotal={
              currentBlindWidth16 && currentBlindDepth16
                ? parseFloat(
                    withoutMotorisationTotal16 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={17}
            total={withoutMotorisationTotal17}
            grandTotal={
              currentBlindWidth17 && currentBlindDepth17
                ? parseFloat(
                    withoutMotorisationTotal17 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={18}
            total={withoutMotorisationTotal18}
            grandTotal={
              currentBlindWidth18 && currentBlindDepth18
                ? parseFloat(
                    withoutMotorisationTotal18 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={19}
            total={withoutMotorisationTotal19}
            grandTotal={
              currentBlindWidth19 && currentBlindDepth19
                ? parseFloat(
                    withoutMotorisationTotal19 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={20}
            total={withoutMotorisationTotal20}
            grandTotal={
              currentBlindWidth20 && currentBlindDepth20
                ? parseFloat(
                    withoutMotorisationTotal20 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={21}
            total={withoutMotorisationTotal21}
            grandTotal={
              currentBlindWidth21 && currentBlindDepth21
                ? parseFloat(
                    withoutMotorisationTotal21 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={22}
            total={withoutMotorisationTotal22}
            grandTotal={
              currentBlindWidth22 && currentBlindDepth22
                ? parseFloat(
                    withoutMotorisationTotal22 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={23}
            total={withoutMotorisationTotal23}
            grandTotal={
              currentBlindWidth23 && currentBlindDepth23
                ? parseFloat(
                    withoutMotorisationTotal23 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={24}
            total={withoutMotorisationTotal24}
            grandTotal={
              currentBlindWidth24 && currentBlindDepth24
                ? parseFloat(
                    withoutMotorisationTotal24 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={25}
            total={withoutMotorisationTotal25}
            grandTotal={
              currentBlindWidth25 && currentBlindDepth25
                ? parseFloat(
                    withoutMotorisationTotal25 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={26}
            total={withoutMotorisationTotal26}
            grandTotal={
              currentBlindWidth26 && currentBlindDepth26
                ? parseFloat(
                    withoutMotorisationTotal26 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={27}
            total={withoutMotorisationTotal27}
            grandTotal={
              currentBlindWidth27 && currentBlindDepth27
                ? parseFloat(
                    withoutMotorisationTotal27 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={28}
            total={withoutMotorisationTotal28}
            grandTotal={
              currentBlindWidth28 && currentBlindDepth28
                ? parseFloat(
                    withoutMotorisationTotal28 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            elementNo={29}
            total={withoutMotorisationTotal29}
            grandTotal={
              currentBlindWidth29 && currentBlindDepth29
                ? parseFloat(
                    withoutMotorisationTotal29 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
          ...
          <ShowBothTotalBelowButton
            ...
            elementNo={30}
            total={withoutMotorisationTotal30}
            grandTotal={
              currentBlindWidth30 && currentBlindDepth30
                ? parseFloat(
                    withoutMotorisationTotal30 +
                      (selectedMotorTypeMultiplier &&
                      selectedMotorTypeExcelValue >= 0
      ...
      <div className=" px-2  justify-center rounded shadow-sm mt-2.5 text-center bg-lime-50 border-2">
        <h1 className="p-2 pt-3 font-semibold text-lime-700 ">
          F I N A L &nbsp; P R I C E
        </h1>
        <div className="">
          {/* <div className={`grid grid-cols-2 px-2 p-1 m-1 border-b-2 border-b-sky-900`}> */}
          <div className="flex items-center justify-between ">
            <h1 className="p-2 font- text-xs sm:text-sm text-lime-700">
              Blinds Total
            </h1>
            <h1 className="p-2 font-medium text-xs sm:text-sm text-lime-700">
              £{" "}
              {parseFloat(
                withoutMotorisationTotal +
                  withoutMotorisationTotal2 +
          ...
          <div className="flex items-center justify-between border-b-2 border-b-lime-700">
            <h1 className="p-2 font-medium text-xs sm:text-sm text-lime-700">
              Blind + Motorization Total
            </h1>
            <h1 className="p-2 font-medium text-xs sm:text-sm text-lime-700">
              £
              {parseFloat(
          ...
          <div className="flex items-center justify-between">
            <h1 className="p-2 font-extrabold text-xs sm:text-sm text-lime-700">
              Grand Total with VAT(20%)
            </h1>
            <h1 className="p-2 font-extrabold text-xs sm:text-sm text-lime-700">
              £
              {parseFloat(
    ...
    <div className="m-5 flex flex-col justify-center items-center">
      ...
      <div className="mt-3 text-xl font-semibold text-gray-800">Loading...</div>
    </div>
  );
};
